import { ServerVariableScope } from "@tailjs/types";

/**
 * An IdProvider is used to map client-local IDs to global IDs in the context of a {@link ServerVariableScope} (session, user or device).
 *
