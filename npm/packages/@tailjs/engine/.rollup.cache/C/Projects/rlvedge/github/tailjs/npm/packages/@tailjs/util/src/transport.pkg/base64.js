const codes = [];
const chars = [];
export const charCode = (s, index = 0) => s.charCodeAt(index);
export const fromCharCodes = (chars) => String.fromCharCode(...chars);
[..."ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"].forEach((p, i) => (codes[(chars[i] = p.charCodeAt(0))] = i));
/**
