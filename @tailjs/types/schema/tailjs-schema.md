...
*Extends*: [TrackedEvent](#type--urn-tailjs-core-TrackedEvent), [SessionEvent](#type--urn-tailjs-core-SessionEvent)
*purposes*: necessary
...
|webdriver|boolean|||The browser is being controlled by automation (e.g., Selenium or Puppeteer).|
...
|Name|Type|Privacy|Purposes|Description|
|-|-|-|-|-|
|components|Array\<[ActivatedComponent](#type--urn-tailjs-core-ActivatedComponent)\>|||Relevant components and their content in the scope of the activated element.|
|content|Array\<[ActivatedComponent](#type--urn-tailjs-core-ActivatedComponent)\>|||The content associated with an element that is not contained by a component.|
...
|clientNavigation|string|||The navigation happened without making an additional request to the server (the [History API](https://developer.mozilla.org/en-US/docs/Web/API/History_API)).|
...
*Extends*: [OrderStatusEvent](#type--urn-tailjs-core-OrderStatusEvent)
*purposes*: necessary
...
|elements|Array\<[ComponentElementInfo](#type--urn-tailjs-core-ComponentElementInfo)\>||||
...
|value|string|||The value of the form field. Be careful with this one.<br><br>The default is only to track whether checkboxes are selected. See` TrackingBehavior.forms ` and` TrackingBehavior.formFields ` for details.|
...
## ImpressionEvent_patch_regions_type {#type--urn-tailjs-core-ImpressionEvent_patch_regions_type}
*purposes*: necessary
...
## SessionEvent {#type--urn-tailjs-core-SessionEvent}
*purposes*: necessary
...
|score|number|||How strongly the tags relates to the target (between 0 and 1).|
...
## TrackingBehavior {#type--urn-tailjs-core-TrackingBehavior}
*purposes*: necessary

|Name|Type|Privacy|Purposes|Description|
|-|-|-|-|-|
|disable|boolean|||Disable tracking for this element and elements below it.<br><br>HTML attribute: `track-disable`. \ CSS: `--track-disable: 0/no/false/1/yes/true`.|
|region|boolean|||Track the coordinates of the visible region occupied by the component or content.<br><br>Inherited by child components (also if specified on non-component DOM element).<br><br>HTML attribute: `track-region`. \ CSS: `--track-region: 0/no/false/1/yes/true`.|
|clicks|boolean|||Track clicks. Note that clicks are always tracked if they cause navigation.<br><br>Inherited by child components (also if specified on non-component DOM element).<br><br>HTML attribute: `track-clicks`. CSS: `--track-clicks: 0/no/false/1/yes/true`.|
|forms|boolean|||Track forms.|
|formFields|[TrackingBehavior_formFields_type](#type--urn-tailjs-core-TrackingBehavior_formFields_type)||||
|impressions|boolean or [TrackingBehavior_1_impressions_type](#type--urn-tailjs-core-TrackingBehavior_1_impressions_type)|||Track impressions, that is, when the component's element becomes visible in the user's browser. This goes well with` region ` .<br><br>Not inherited by child components.<br><br>Not configurable via HTML/CSS.|

## TrackingBehavior_1_impressions_type {#type--urn-tailjs-core-TrackingBehavior_1_impressions_type}
*purposes*: necessary

|Name|Type|Privacy|Purposes|Description|
|-|-|-|-|-|
|delay|number|||Do not count the impression before the component has been visible for at least this amount of milliseconds|

## TrackingBehavior_formFields_type {#type--urn-tailjs-core-TrackingBehavior_formFields_type}
*purposes*: necessary

|Name|Type|Privacy|Purposes|Description|
|-|-|-|-|-|
|privacy|string|||Minimum consent classification before values are tracked.<br><br>HTML attribute: `track-form-privacy`. CSS: `--track-form-privacy: 0/no/false/1/yes/true/none/checkbox-only/all`.|
|values|boolean or string|||Which form fields to track values for.<br><br>HTML attribute: `track-form-field`. CSS: `--track-form-field: 0/no/false/1/yes/true/none/checkbox-only/all`.|

## UserAgentEvent_patch_screen_type {#type--urn-tailjs-core-UserAgentEvent_patch_screen_type}
*purposes*: necessary
...
## UserAgentEvent_patch_timezone_type {#type--urn-tailjs-core-UserAgentEvent_patch_timezone_type}
*purposes*: necessary
...
## ViewEvent_patch_externalReferrer_type {#type--urn-tailjs-core-ViewEvent_patch_externalReferrer_type}
*purposes*: necessary
...
## ViewEvent_patch_utm_type {#type--urn-tailjs-core-ViewEvent_patch_utm_type}
*purposes*: necessary
...
|item|[ExternalReference](#type--urn-tailjs-core-ExternalReference)|||The item that relates to this quantity. If not explicitly set it will get its value from the closest associated content in a` UserInteractionEvent ` context.|
...
|Name|Type|Privacy|Purposes|Description|
|-|-|-|-|-|
|source|string|||Where the consent comes from (typically Google Consent Mode v2 via a cookie consent screen).|
...
|dataSource|[DataSource](#type--urn-tailjs-core-DataSource)|||Optional references to the content that was used to render the component.|
...
## DataSource {#type--urn-tailjs-core-DataSource}
*Extends*: [ExternalReference](#type--urn-tailjs-core-ExternalReference), [Tagged](#type--urn-tailjs-core-Tagged)
*purposes*: necessary
...
## ComponentTrackingBehavior {#type--urn-tailjs-core-ComponentTrackingBehavior}
*Extends*: [TrackingBehavior](#type--urn-tailjs-core-TrackingBehavior)
*purposes*: necessary

|Name|Type|Privacy|Purposes|Description|
|-|-|-|-|-|
|promote|boolean|||Always include content and component, also if it is a parent component. By default only the closest component will be included.<br><br>This does not apply to impression tracking.<br><br>Not inherited by child components.<br><br>HTML attribute: `track-promote`. CSS: `--track-promote: 0/no/false/1/yes/true`.|
|secondary|boolean|||The component will only be tracked with the closest non-secondary component as if the latter had the` promote ` flag.<br><br>This does not apply to impression tracking.<br><br>Not inherited by child components.<br><br>HTML attribute: `track-secondary`. \ CSS: `--track-secondary: 0/no/false/1/yes/true`.|

## CartEventData {#type--urn-tailjs-core-CartEventData}
*Extends*: [Tagged](#type--urn-tailjs-core-Tagged), [OrderQuantity](#type--urn-tailjs-core-OrderQuantity)
*purposes*: necessary
...
|Name|Type|Privacy|Purposes|Description|
|-|-|-|-|-|
|track|[ComponentTrackingBehavior](#type--urn-tailjs-core-ComponentTrackingBehavior)|||Settings for how the component will be tracked.<br><br>These settings are not tracked, that is, this property is stripped from the data sent to the server.|
