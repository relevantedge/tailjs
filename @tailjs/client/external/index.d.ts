...
declare const CLIENT_CONFIG: Required<Omit<TrackerClientConfiguration, "scriptBlockerAttributes">>;
declare const setTrackerName: (name: string) => ProvisionalTracker;
declare let tail: ProvisionalTracker;

export { type AnyVariableScope, CLIENT_CONFIG, type CartCommand, type ChangeUserCommand, type ClientScoped, type ClientVariable, type ClientVariableGetResult, type ClientVariableGetter, type ClientVariableGetterCallback, type ClientVariableKey, type ClientVariableSetResult, type ClientVariableSetter, type ClientVariableSetterCallback, type ComponentOrContent, type ConfigurationCommand, type ConsentCallback, type ConsentCommand, type CurrentView, type ExtensionCommand, type ExternalConsentPoller, type FlushCommand, type FormCommand, type FormCommandAction, type GetCommand, type Listener, type ListenerArgs, type ListenerCommand, type LocalVariableScope, type OrderCommand, type ProvisionalTracker, type ReferringViewData, type ReservedTrackerVariables, type ScanComponentsCommand, type SetCommand, type TagAttributesCommand, type TagMappings, type ToggleCommand, type TrackEventCommand, type Tracker, type TrackerAttributes, type TrackerClientConfiguration, type TrackerCommand, type TrackerExtension, type TrackerExtensionFactory, type TrackingBoundaryDataCommand, type UnlockApiCommand, type UseTrackerCommand, type VariableCacheSettings, type ViewCommand, anyVariableScope, isCartCommand, isChangeUserCommand, isConfigurationCommand, isExtensionCommand, isFlushCommand, isFormCommand, isGetCommand, isListenerCommand, isLocalScopeKey, isOrderCommand, isScanComponentsCommand, isSetCommand, isTagAttributesCommand, isToggleCommand, isTrackerAvailableCommand, isTrackingDataCommand, isUpdateConsentCommand, isViewCommand, localVariableScope, maskEntityId, setTrackerName, stringToVariableKey, tail, variableKeyToString };
