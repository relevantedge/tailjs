import { isConsentEvent, isResetEvent, isUserAgentEvent, isViewEvent, isSignInEvent, DataClassification, isSignOutEvent, DataUsage, isOrderEvent, isCartEvent, TypeResolver, ValidationError, isPassiveEvent, JsonSchemaAdapter, CORE_SCHEMA_NS, DataPurposes, iterateQueryResults, toVariableResultPromise, VariableResultStatus, isVariableResult, extractKey, filterKeys, VariableServerScope, formatVariableResult, VALIDATION_ERROR_SYMBOL, formatVariableKey, formatValidationErrors, isTransientError, extractVariable, isSuccessResult, filterRangeValue, validateVariableKeySyntax } from '@tailjs/types';
import { now, map, skip, filter, throwError, indent, formatError, hasKeys, parseUri, join, deferred, obj, parseQueryString, unwrap, isJsonObject, isJsonString, match, isString, createLock, merge, isPlainObject, concat, get, some, forEach, truish, isArray, createEvent, required, ellipsis, add, isObject, parseHttpHeader, parameterListSymbol, jsonClone, group, distinct, keys, forEachAwait, itemize, keyCount, array, delay } from '@tailjs/util';
import { defaultTransport, hash, createTransport, httpEncode, defaultJsonTransport, decodeUtf8, httpDecode } from '@tailjs/transport';
...
const BUILD_REVISION_QUERY = "rev=" + "meskp5x9" ;
