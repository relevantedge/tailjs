...
public record SessionStartedEvent(
  ...
  TimeSpan? TimeSinceLastSession = null
) : ITrackedEvent
{
  /// <summary>
  ...
  /// </summary>
  public string Type => "SESSION_STARTED";
  ...
  /// </summary>
  public long? SessionNumber { get; set; } = SessionNumber;
  
  /// <summary>
  /// The time since the last session from this device.
  /// </summary>
  public TimeSpan? TimeSinceLastSession { get; set; } = TimeSinceLastSession;
}
