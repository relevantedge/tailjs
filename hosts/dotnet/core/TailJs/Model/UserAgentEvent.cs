...
public record UserAgentEvent(
  string UserAgent,
  UserAgentEventTimezone Timezone,
  ...
  long? Timestamp = null,
  bool? HasTouch = null,
  UserAgentEventDeviceType? DeviceType = null,
  List<UserAgentLanguage?>? Languages = null,
  UserAgentEventScreen? Screen = null
) : ITrackedEvent, ISessionScoped
{
  /// <summary>
  ...
  public UserAgentEventTimezone Timezone { get; set; } = Timezone;
  ...
  /// Has touch
  /// </summary>
  public bool? HasTouch { get; set; } = HasTouch;
  
  /// <summary>
  /// The device type (inferred from screen size). The assumption is:   - anything width a logical device pixel width less than 480 is a phone,   - anything with a logical device pixel width less than or equal to 1024 (iPad Pro12.9&quot;) is a tablet,   - the rest are desktops.
  /// 
  /// Device width is the physical width of the device regardless of its orientation.
  /// </summary>
  public UserAgentEventDeviceType? DeviceType { get; set; } = DeviceType;
  
  /// <summary>
  /// The user&#39;s language preferences as configured in the user&#39;s device.
  /// </summary>
  public List<UserAgentLanguage?>? Languages { get; set; } = Languages;
  
  /// <summary>
  /// Screen
  /// </summary>
  public UserAgentEventScreen? Screen { get; set; } = Screen;
}


#region Anonymous types

  public record UserAgentEventTimezone(
    string Iana,
    double Offset
  )
  {
    public string Iana { get; set; } = Iana;
  ...
  /// Screen
  /// </summary>
  public record UserAgentEventScreen(
    double Dpr,
    double Width,
    double Height,
    bool? Landscape = null
  )
  {
    ...
    /// </summary>
    public bool? Landscape { get; set; } = Landscape;
  }
...
#region Enums
  ...
  public enum UserAgentEventDeviceType
  {
    Mobile,
    Tablet,
    Desktop
