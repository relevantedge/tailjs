...
public record SearchEvent(
  ...
  string? Query = null,
  Dictionary<string, SearchParameter?>? SearchParameter = null,
  long? ResultCount = null,
  List<SearchResult?>? SignificantResults = null
) : IUserInteractionEvent
{
  ...
  public Dictionary<string, SearchParameter?>? SearchParameter { get; set; } = SearchParameter;
  
  public long? ResultCount { get; set; } = ResultCount;
  
  public List<SearchResult?>? SignificantResults { get; set; } = SignificantResults;
}
