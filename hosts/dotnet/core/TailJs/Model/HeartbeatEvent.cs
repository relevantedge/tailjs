...
/// <summary>
/// An event that may be sent regularaly from the client to indicate how long it has been alive. In case  <see cref="ViewEndedEvent"/> s are not sent or gets lost these heartbeats can be used to approximate page view durations.
/// </summary>
...
) : ITrackedEvent, IViewTimingEvent, ISystemEvent
{
  /// <summary>
