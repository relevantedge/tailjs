...
public record SessionLocationEvent(
  ...
  GeoEntity? City = null,
  string? Zip = null,
  GeoEntity? Subdivision = null,
  GeoEntity? Country = null,
  GeoEntity? Continent = null,
  double? Lat = null,
  double? Lng = null,
...
) : ITrackedEvent, ISessionScoped
{
  ...
  /// </summary>
  public string Type => "SESSION_LOCATION";
  ...
  /// <summary>
  /// This number is like the precise definition of what the bars indicating signal strength on mobile phones represents. Nobody knows. Yet, for this number lower is better.
  /// </summary>
  public double? Accuracy { get; set; } = Accuracy;
  
  public GeoEntity? City { get; set; } = City;
  
  public string? Zip { get; set; } = Zip;
  
  public GeoEntity? Subdivision { get; set; } = Subdivision;
  
  public GeoEntity? Country { get; set; } = Country;
  
  public GeoEntity? Continent { get; set; } = Continent;
  
  public double? Lat { get; set; } = Lat;
  
  public double? Lng { get; set; } = Lng;
  
  public object? ProviderData { get; set; } = ProviderData;
}


#region Anonymous types

  public record SessionLocationEventProviderData(
  );
