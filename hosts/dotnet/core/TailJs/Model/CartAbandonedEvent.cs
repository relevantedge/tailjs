...
public record CartAbandonedEvent(
  ...
  decimal? Delivery = null,
  decimal? Vat = null,
  decimal? Total = null,
  string? PaymentMethod = null,
  string? Currency = null,
  long? LastCartEvent = null
) : ICommerceEvent, IOrder
{
  /// <summary>
  ...
  /// </summary>
  public string Type => "CART_ABANDONED";
  ...
  /// </summary>
  public List<OrderLine?>? Items { get; set; } = Items;
  ...
  /// </summary>
  public decimal? Delivery { get; set; } = Delivery;
  ...
  /// This is a Unix timestamp (milliseconds).
  /// </summary>
  public long? LastCartEvent { get; set; } = LastCartEvent;
}
