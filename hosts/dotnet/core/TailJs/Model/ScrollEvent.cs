...
public record ScrollEvent(
  ...
  ScrollEventScrollType? ScrollType = null
) : IUserInteractionEvent
{
  ...
  /// </summary>
  public ScreenPosition Offset { get; set; } = Offset;
  ...
  /// </summary>
  public ScrollEventScrollType? ScrollType { get; set; } = ScrollType;
}
...
#region Enums
  ...
  public enum ScrollEventScrollType
  {
    Fold,
    ArticleEnd,
    PageMiddle,
